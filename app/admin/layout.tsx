...
import { LayoutDashboard, Film, Ticket, Users, Settings, Menu, X, Phone, TestTube, ChevronDown, User, Shield, Bell, LogOut } from "lucide-react"
...
const adminNavItems = [
  ...
  { href: "/admin/test", icon: TestTube, label: "🚀 Test API" },
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  ...
                  <p className="text-xs leading-none text-muted-foreground">admin@cinema.vn</p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
            ...
            <ul className="space-y-2">
              {adminNavItems.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-accent hover:text-accent-foreground hover:translate-x-1"
